...
public class ScalingTextureView extends TextureView {
    ...
    private com.example.photofilters.MoveGestureDetector mMoveDetector;
    ...
    private void init(Context context) {
        ...
        mMoveDetector = new com.example.photofilters.MoveGestureDetector(context, (com.example.photofilters.MoveGestureDetector.OnMoveGestureListener) new MoveListener());
    }
    ...
    private class MoveListener extends com.example.photofilters.MoveGestureDetector.SimpleOnMoveGestureListener {
        @Override
        public boolean onMove(com.example.photofilters.MoveGestureDetector detector) {
