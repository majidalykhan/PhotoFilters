        ...
        VerticalSlideColorPicker.OnColorChangeListener
{
    ...
    mSaveContainer, mStickerContainer, mTrashContainer, mGalleryContainer, mArtisticContainer;
    ...
    private void showStillshotContainer(){
        ...
        mGalleryContainer.setVisibility(View.INVISIBLE);
        mArtisticContainer.setVisibility(View.INVISIBLE);
